    ...
    return (
        <ServicesContainer id="services">
            ...
            <ServicesWrapper>
                ...
                <ServicesCard>
                    <ServicesIcon src={Icon2} onClick={() => {window.open.location.href="https://github.com/jaypeura/valeriebot/"}}/>
                    <ServicesH2>Discord.js bot</ServicesH2>
                </ServicesCard>
                <ServicesCard>
                    <ServicesIcon src={Icon3} onClick={() => {window.open.href="https://jaypeura.github.io/weather/"}}/>
